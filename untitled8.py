# -*- coding: utf-8 -*-
"""
Created on Mon Jan 11 09:27:12 2021
...
def efficient_test_typeQDII(start_date=datetime(year=2009, month=1, day=1),end_date=datetime(year=2020, month=9, day=30)):
    ...
    IC_mean.to_excel(os.path.join(plot_path, 'IC_mean_QDII_2.xlsx'))
    IC_std.to_excel(os.path.join(plot_path, 'IC_std_QDII_2.xlsx'))
    IR.to_excel(os.path.join(plot_path, 'IR_QDII_2.xlsx'))
    IC_win.to_excel(os.path.join(plot_path, 'IC_win_QDII_2.xlsx'))